      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="inner_layout_end.php" method="post" enctype="multipart/form-data">
            <?php
              $temp = gettoken_value();
...
var serialization = [
<?php
  $rs=SelectSqlDB("select A.*,B.title from inner_layout A left join chart B on B.id=A.chart_id order by A.id");
...
function save(){
    ...
    $.post('inner_list_end.php',{edit:'edit', data:JSON.stringify(data)}, function(val){
        alert(val);
    });
}
</script>
