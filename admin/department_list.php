          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="box-header">
                ...
                <button type="button" onclick="location.href='department_edit.php'" class="btn  btn-success btn-sm"><i class="fa fa-plus"></i> 新增</button>

                <button type="button" name="data_del" tables="department" field="id" class="btn  btn-danger btn-sm"><i class="fa"></i> 批次刪除</button>
              ...
              <div class="table-responsive ">
                ...
                <tr>
                  ...
                  <?php
                      ...
                      $query = "SELECT * from department where 1=1 order by [sort] asc, [id] asc";
                          ...
                          if (count($result["data"]) > 0) {
                              foreach($result["data"] as $row){
                                  ...
                                  echo '	 <td>
                                              ...
                                              <input type="number" name="orders" class="form-control" min="1" max="99" required value="' . $row["sort"] . '" onchange="set_orders(this)" title="請輸入1~99之間" data-toggle="tooltip" set_field="sort" where_field_int="' . $row["id"] . '" tables="department" where_field="id" />
                                  ...
                                  echo '<td>';
                                  echo '<a href="department_edit.php?edit=true&id=' . $row["id"] . '"><button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary"  >修改</button></a>';
                                  echo '</td>';
